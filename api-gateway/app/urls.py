...
from .views import (
    dashboard, book_detail, login_page, register_page, view_books, add_book,
    cart_page, checkout_page, shipping_page, shipping_list_page,
    staff_list_page, customer_list_page, favorites_page
)
...
urlpatterns = [
    ...
    path('customer/favorites/', favorites_page, {'template': 'customer_favorites.html'}, name='customer_favorites'),
